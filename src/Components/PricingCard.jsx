...
const PricingCard = ({plan,fun}) => {
  return (
   <>
    <div className='bg-[#3B0467] w-fit rounded-[5px] flex flex-col gap-[1rem]  py-[2rem] hover:scale-[1.02] transition-all cursor-pointer'>
        ...
        }} className='w-[80%]  hover:scale-[1.02] transition-all p-[0.2rem] m-auto rounded-[5px] mt-[1rem] bg-gray-900 text-[1.3rem]'>Buy Now</button>
    </div>
   </>
  )
}
