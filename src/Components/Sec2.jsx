    ...
    <div className="flex justify-around my-[7rem] flex-wrap below-sm:gap-[3rem]">
        {
            data.map((i,index)=>{
                return(
                    <div onClick={() => dosomething(i.head)}  key={index} className="w-[28%] cursor-pointer hover:scale-[1.02] transition-all flex flex-col gap-[1.3rem] justify-center items-center p-[1rem] rounded-lg   shadow-custom below-sm:w-[90%] ">
