    ...
    <div className='flex pt-[8rem] justify-center item-center below-sm:pt-[12rem]' >
        <form onSubmit={submit} className='w-[40%] below-sm:w-[95%] flex flex-col justify-center  border-[2px] border-gray-500 p-[1rem] rounded-[1rem] gap-[1rem]' >
            <div className='flex flex-col gap-[0.5rem]'>
                <h3 className='text-[1.2rem] font-semibold'>UserName</h3>
            ...
            <button className='mt-[0.5rem] text-[1.2rem] bg-purple-900 p-[0.4rem] rounded-[8px] hover:scale-[1.01] transition-all ' type='submit'>SignUp</button>
            <h3 className='text-[1.2rem]'>Already have account ? <Link href={"/login"} className='text-blue-700' >Login</Link></h3>
        </form>
    </div>
    <ToastContainer
position="top-right"
